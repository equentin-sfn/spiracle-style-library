...
const pricingPlans: PricingPlan[] = [
  {
    name: "Free",
    audienceLabel: "The Curious",
    monthlyPrice: "Free",
    features: [
      { text: "Access to free catalogue", included: true },
      { text: "Weekly curated picks", included: true },
      { text: "Basic playback features", included: true },
      { text: "Community forums", included: true },
      { text: "Unlimited listening", included: false },
  ...
  {
    name: "Supporter",
    audienceLabel: "The Grazer",
    monthlyPrice: 3,
    annualPrice: 30,
    features: [
      { text: "Everything in Free", included: true },
      { text: "1 audiobook credit per month", included: true },
      { text: "Keep your books forever", included: true },
      { text: "Support independent publishing", included: true },
      { text: "Unlimited listening", included: false },
      { text: "Early access to new releases", included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "2 audiobook credits per month", included: true },
      { text: "Unlimited listening to library", included: true },
      { text: "Offline downloads", included: true },
      { text: "Member-only essays & podcasts", included: true },
      { text: "Early access to new releases", included: false },
      { text: "Exclusive member events", included: false },
    ],
    ctaText: "Join as Reader",
    ctaHref: "/join/reader",
  },
  {
    name: "Avid Reader",
    ...
    features: [
      ...
      { text: "4 audiobook credits per month", included: true },
      { text: "Unlimited listening to library", included: true },
      { text: "Offline downloads", included: true },
      { text: "Early access to new releases", included: true },
      { text: "Exclusive member events", included: true },
      { text: "Annual gift for loyal members", included: true },
    ],
    ctaText: "Join as Avid Reader",
